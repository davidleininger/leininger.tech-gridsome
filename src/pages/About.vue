<template>
  <TwoCol>
    ...
    <section class="flex flex-col lg:flex-row items-start">
      <div class="w-full lg:w-2/3 my-4 md:mt-0 md:pr-8 prose dark:prose-dark">
...
<script>
import TwoCol from '~/layouts/TwoColumn.vue'
export default {
  metaInfo: {
    title: 'About us'
  },
